...
export function revokeOffer(starIndex) {
    ...
    return function(dispatch) {
      ...
      web3.eth.getCoinbase((error, coinbase) => {
        ...
        starMarket.deployed().then(function(instance) {
          ...
          starMarketInstance.starNoLongerForSale(starIndex, {from: coinbase, gas: 200000}).then(function(result) {
            console.log('revoke offer for star', result);
          })
        })
      })
    }
