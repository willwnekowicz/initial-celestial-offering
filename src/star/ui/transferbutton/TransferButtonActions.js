...
export function transferStar(to, starIndex) {
    ...
    return function(dispatch) {
      ...
      web3.eth.getCoinbase((error, coinbase) => {
        ...
        starMarket.deployed().then(function(instance) {
          ...
          starMarketInstance.transferStar(to, starIndex, {from: coinbase, gas: 200000}).then(function(result) {
            console.log('transferred star', result);
          })
        })
      })
    }
