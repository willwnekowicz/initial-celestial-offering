...
export function acceptBid(starIndex, minAmount) {
    ...
    return function(dispatch) {
      ...
      web3.eth.getCoinbase((error, coinbase) => {
        ...
        starMarket.deployed().then(function(instance) {
          ...
          let minAmountInWei = minAmount * 1000000000000000000;

          starMarketInstance.acceptBidForStar(starIndex, minAmountInWei, {from: coinbase, gas: 200000}).then(function(result) {
            console.log('accepted bid for star', result);
          })
        })
      })
    }
